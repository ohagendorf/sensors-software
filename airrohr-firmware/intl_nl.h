...
const char INTL_FEINSTAUBSENSOR[] PROGMEM = "Fijnstof sensor";
...
const char INTL_DISPLAY[] PROGMEM = "Scherm";
...
const char INTL_WEITERE_APIS[] PROGMEM = "Meer API";
...
const char INTL_PASSWORT[] PROGMEM = "Paswoord";
const char INTL_SENDEN_AN[] PROGMEM = "Verzend naar {v}";
const char INTL_LESE[] PROGMEM = "Lees van";
...
const char INTL_ZURUCK_ZUR_STARTSEITE[] PROGMEM = "Terug naar home pagina";
...
const char INTL_SETZE_DEBUG_AUF[] PROGMEM = "Debug setting naar ";
...
const char INTL_ERSTER_MESSZYKLUS[] = "Nog {v} seconden voor de eerste meting.";
